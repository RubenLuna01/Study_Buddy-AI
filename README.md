...
Friendly AI chatbot that lets you upload study documents (PDF or TXT)
and ask questions about them. Built with Python, Flask, and the OpenAI API.

This project is designed to:
- Get and use an OpenAI API key
- Connect Python code to an external API
- Deploy a web app using Replit
...
| File | Purpose |
|------|---------|
| `config.py` | **Start here.** API key and settings here. |
